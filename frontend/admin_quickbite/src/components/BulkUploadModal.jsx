...
const BulkUploadModal = ({ onClose, onSuccess }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const res = await bulkCreateCategories({ items }, token);
            ...
            setError(err.response?.data?.message || err.message || "Failed to upload categories.");
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-lg w-full max-w-2xl p-6 relative animate-fade-in max-h-[90vh] overflow-y-auto scrollbar-hide">
                ...
                <p className="text-gray-500 text-sm mb-6">
                    Add multiple categories at once by uploading a JSON file or pasting JSON data.
                </p>
